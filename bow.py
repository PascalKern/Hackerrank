...
# Die Klasse DocumentClass ist die Klasse für unser Dokumentenklassen. Sie erbt von der Klasse Document. 
...
# ###############################################################################################################################
# Die Pool-Klasse
""" Die Klasse pool ist die Klasse, in der die Dokumentenklassen gelernt werden, und die die Klassifikationsmethoden zur Verfügung 
stellt:  """
class Pool(object):
    def __init__(self):
...
# ###############################################################################################################################        
# Benutzung des Klassifikators
""" Damit Sie einen Klassifikator lernen und testen können, stellen wir einen ein "Lern und Testset zum Download" zur Verfügung. 
Dabei handelt es sich um sechs Klassen mit englischen Witzen der Rubriken "clinton", "lawyer", "math", "medical", "music", "sex". """
